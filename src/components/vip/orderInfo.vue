        ...
        methods:{
            getOrderInfoData(){
                ...
                this.$axios.get(url).then(response=>{
                    console.log(response.data.message.orderinfo)
                    //订单页面的详情
